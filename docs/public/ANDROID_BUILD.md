...
```text
/var/lib/helpify-mydealer/android-builds/v0.17.0/
├── Helpify-v0.17.0-debug.apk
├── MyDealer-v0.17.0-debug.apk
├── Helpify-v0.17.0-badging.txt
├── MyDealer-v0.17.0-badging.txt
├── SHA256SUMS.txt
└── build.env
```
