...
grep -Fq 'versionCode 1700' "$ROOT/implementation/android-native/helpify/build.gradle" \
  && pass "Helpify versionCode 1700" || fail "Helpify versionCode 1700"
grep -Fq "versionName '0.17.0'" "$ROOT/implementation/android-native/helpify/build.gradle" \
  && pass "Helpify versionName 0.17.0" || fail "Helpify versionName 0.17.0"
grep -Fq 'versionCode 1700' "$ROOT/implementation/android-native/mydealer/build.gradle" \
  && pass "MyDealer versionCode 1700" || fail "MyDealer versionCode 1700"
grep -Fq "versionName '0.17.0'" "$ROOT/implementation/android-native/mydealer/build.gradle" \
