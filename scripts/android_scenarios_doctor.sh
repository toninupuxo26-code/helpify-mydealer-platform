...
grep -Fq 'versionCode 1600' "$ROOT/implementation/android-native/helpify/build.gradle" \
  && pass "Helpify versionCode 1600" || fail "Helpify versionCode 1600"
grep -Fq "versionName '0.16.0'" "$ROOT/implementation/android-native/helpify/build.gradle" \
  && pass "Helpify versionName 0.16.0" || fail "Helpify versionName 0.16.0"
grep -Fq 'versionCode 1600' "$ROOT/implementation/android-native/mydealer/build.gradle" \
  && pass "MyDealer versionCode 1600" || fail "MyDealer versionCode 1600"
grep -Fq "versionName '0.16.0'" "$ROOT/implementation/android-native/mydealer/build.gradle" \
