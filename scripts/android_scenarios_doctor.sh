...
grep -Fq 'versionCode 1200' "$ROOT/implementation/android-native/helpify/build.gradle" \
  && pass "Helpify versionCode 1200" || fail "Helpify versionCode 1200"
grep -Fq "versionName '0.12.0'" "$ROOT/implementation/android-native/helpify/build.gradle" \
  && pass "Helpify versionName 0.12.0" || fail "Helpify versionName 0.12.0"
grep -Fq 'versionCode 1200' "$ROOT/implementation/android-native/mydealer/build.gradle" \
  && pass "MyDealer versionCode 1200" || fail "MyDealer versionCode 1200"
grep -Fq "versionName '0.12.0'" "$ROOT/implementation/android-native/mydealer/build.gradle" \
  && pass "MyDealer versionName 0.12.0" || fail "MyDealer versionName 0.12.0"
