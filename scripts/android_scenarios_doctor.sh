...
grep -Fq 'versionCode 1500' "$ROOT/implementation/android-native/helpify/build.gradle" \
  && pass "Helpify versionCode 1500" || fail "Helpify versionCode 1500"
grep -Fq "versionName '0.15.0'" "$ROOT/implementation/android-native/helpify/build.gradle" \
  && pass "Helpify versionName 0.15.0" || fail "Helpify versionName 0.15.0"
grep -Fq 'versionCode 1500' "$ROOT/implementation/android-native/mydealer/build.gradle" \
  && pass "MyDealer versionCode 1500" || fail "MyDealer versionCode 1500"
grep -Fq "versionName '0.15.0'" "$ROOT/implementation/android-native/mydealer/build.gradle" \
