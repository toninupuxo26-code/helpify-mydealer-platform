...
grep -Fq 'versionCode 1100' "$ROOT/implementation/android-native/helpify/build.gradle" \
  && pass "Helpify versionCode 1100" || fail "Helpify versionCode 1100"
grep -Fq "versionName '0.11.0'" "$ROOT/implementation/android-native/helpify/build.gradle" \
  && pass "Helpify versionName 0.11.0" || fail "Helpify versionName 0.11.0"
grep -Fq 'versionCode 1100' "$ROOT/implementation/android-native/mydealer/build.gradle" \
  && pass "MyDealer versionCode 1100" || fail "MyDealer versionCode 1100"
grep -Fq "versionName '0.11.0'" "$ROOT/implementation/android-native/mydealer/build.gradle" \
  && pass "MyDealer versionName 0.11.0" || fail "MyDealer versionName 0.11.0"
